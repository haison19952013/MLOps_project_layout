...
## Note:
- You might want to remove lines related to `.gitkeep` in the scripts (i.e., `make.sh` or `make.bat`) because it's just a way to keep the empty folder in the `Github` repository.
